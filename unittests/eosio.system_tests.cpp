...
public:
   ...
   eosio_system_tester() {
      ...
      //BOOST_REQUIRE_EQUAL( asset::from_string("999999998.5000 SYS"), get_balance( "eosio" ) );
   ...
   asset get_balance( const account_name& act ) {
      //return get_currency_balance( config::system_account_name, symbol(SY(4,SYS)), act );
...
BOOST_FIXTURE_TEST_CASE(producer_pay, eosio_system_tester, * boost::unit_test::tolerance(1e-10)) try {
   ...
   create_account_with_resources( N(defproducera), N(eosio), asset::from_string("1.0000 SYS"), false, large_asset, large_asset );
   create_account_with_resources( N(defproducerb), N(eosio), asset::from_string("1.0000 SYS"), false, large_asset, large_asset );

   create_account_with_resources( N(producvotera), N(eosio), asset::from_string("1.0000 SYS"), false, large_asset, large_asset );
   create_account_with_resources( N(producvoterb), N(eosio), asset::from_string("1.0000 SYS"), false, large_asset, large_asset );
...
BOOST_FIXTURE_TEST_CASE(multiple_producer_pay, eosio_system_tester, * boost::unit_test::tolerance(1e-10)) try {
   ...
   create_account_with_resources( N(producvotera), N(eosio), asset::from_string("1.0000 SYS"), false, net, cpu );
   create_account_with_resources( N(producvoterb), N(eosio), asset::from_string("1.0000 SYS"), false, net, cpu );
   create_account_with_resources( N(producvoterc), N(eosio), asset::from_string("1.0000 SYS"), false, net, cpu );
...
BOOST_FIXTURE_TEST_CASE(producer_onblock_check, eosio_system_tester) try {
   ...
   create_account_with_resources( N(producvotera), N(eosio), asset::from_string("1.0000 SYS"), false, large_asset, large_asset );
   create_account_with_resources( N(producvoterb), N(eosio), asset::from_string("1.0000 SYS"), false, large_asset, large_asset );
   create_account_with_resources( N(producvoterc), N(eosio), asset::from_string("1.0000 SYS"), false, large_asset, large_asset );
   ...
   issue( "producvotera", "100000000.0000 SYS", config::system_account_name);
   BOOST_REQUIRE_EQUAL(success(), stake("producvotera", "30000000.0000 SYS", "30000000.0000 SYS"));
   BOOST_REQUIRE_EQUAL(success(), push_action(N(producvotera), N(voteproducer), mvo()
                                                ("voter",  "producvotera")
                                                ("proxy", name(0).to_string())
   ...
   issue( "producvoterb", "100000000.0000 SYS", config::system_account_name);
   BOOST_REQUIRE_EQUAL(success(), stake("producvoterb", "30000000.0000 SYS", "30000000.0000 SYS"));
   issue( "producvoterc", "100000000.0000 SYS", config::system_account_name);
   BOOST_REQUIRE_EQUAL(success(), stake("producvoterc", "30000000.0000 SYS", "30000000.0000 SYS"));
